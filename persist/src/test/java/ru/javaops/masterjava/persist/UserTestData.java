...
public class UserTestData {
    ...
    public static void init() {
        ...
        DELETED = new User("Deleted", "deleted@yandex.ru", UserFlag.deleted, 2);
        FULL_NAME = new User("Full Name", "gmail@gmail.com", UserFlag.active, 1);
        USER1 = new User("User1", "user1@gmail.com", UserFlag.active, 3);
        USER2 = new User("User2", "user2@yandex.ru", UserFlag.active, 5);
